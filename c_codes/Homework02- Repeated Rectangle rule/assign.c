...
// START OF SECTION THAT YOU MUST WRITE 

   // (-99999 is just a dummy number for "value" until you replace it with something meaningful)
   value=-99999.0;

// END OF SECTION THAT YOU MUST WRITE 
